...
import { discardUserTranscript, upsertAssistantTranscript, upsertUserTranscript, } from "./message-order.js";
...
function taskCreatedAtLabel(timestamp) {
    if (!timestamp)
        return '';
