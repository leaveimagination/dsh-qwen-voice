...
export function QwenVoice(props) {
    ...
    return createPortal((_jsxs("div", { className: css.root, children: [enabled && _jsx("span", { className: css.pulse, "aria-hidden": true }), _jsx("button", { ref: buttonRef, type: "button", className: css.button, "data-active": enabled, "data-state": state, "data-error": Boolean(error), "aria-label": enabled ? '关闭 Qwen 语音' : '开启 Qwen 语音', "aria-pressed": enabled, title: status, onMouseDown: event => event.preventDefault(), children: _jsx("svg", { viewBox: "0 0 24 24", width: "17", height: "17", "aria-hidden": true, children: _jsx("path", { fill: "currentColor", d: "M12 15.5a3.5 3.5 0 0 0 3.5-3.5V6a3.5 3.5 0 1 0-7 0v6a3.5 3.5 0 0 0 3.5 3.5Zm-1.8-9.5a1.8 1.8 0 1 1 3.6 0v6a1.8 1.8 0 1 1-3.6 0V6Zm7.8 5.4a.85.85 0 0 1 .85.85 6.85 6.85 0 0 1-6 6.8v2.1h2.4a.85.85 0 1 1 0 1.7h-6.5a.85.85 0 1 1 0-1.7h2.4v-2.1a6.85 6.85 0 0 1-6-6.8.85.85 0 1 1 1.7 0 5.15 5.15 0 0 0 10.3 0 .85.85 0 0 1 .85-.85Z" }) }) }), open && (_jsxs("section", { className: css.panel, "aria-live": "polite", children: [_jsxs("div", { className: css.head, children: [_jsxs("span", { className: css.status, children: [_jsx("i", { className: css.dot, "data-connected": connected }), _jsxs("span", { children: [_jsx("b", { children: "Qwen \u8BED\u97F3\u534F\u8C03\u4E2D\u5FC3" }), _jsxs("small", { children: [status, activeCount > 0 ? ` · ${activeCount} 项活跃` : ''] })] })] }), _jsx("button", { type: "button", className: css.button, "aria-label": "\u5173\u95ED\u8BED\u97F3\u9762\u677F", onClick: () => setOpen(false), children: "\u00D7" })] }), _jsx("p", { className: css.transcript, children: transcript }), _jsxs("div", { className: css.commands, children: [_jsx("b", { children: "\u5355\u9875\u591A\u4F1A\u8BDD\u6307\u4EE4" }), _jsx("span", { children: "\u201C\u65B0\u5EFA\u524D\u7AEF\u5F00\u53D1\u4F1A\u8BDD\uFF0C\u8BA9\u5B83\u505A\u767B\u5F55\u9875\u201D" }), _jsx("span", { children: "\u201C\u7ED9\u524D\u7AEF\u5F00\u53D1\u8FFD\u52A0\uFF1A\u6539\u6210\u6DF1\u8272\u4E3B\u9898\u201D" }), _jsx("span", { children: "\u201C\u4EE3\u7801\u5BA1\u67E5\u4F1A\u8BDD\u8FDB\u5C55\u5982\u4F55\uFF1F\u201D" })] }), tasks.length > 0 && (_jsx("div", { className: css.tasks, "aria-label": "DSH \u591A\u4F1A\u8BDD\u4EFB\u52A1", children: tasks.map(task => (_jsxs("div", { className: css.task, "data-phase": task.phase, children: [_jsx("i", { "aria-hidden": true }), _jsxs("span", { children: [_jsx("b", { children: task.title }), _jsxs("small", { children: [_jsx("em", { children: "\u534F\u8C03 Agent" }), _jsx("i", { "aria-hidden": true, children: "\u2192" }), _jsx("em", { children: task.targetSessionId ? '目标 DSH 会话' : '正在路由' })] }), _jsxs("small", { children: [taskPhaseLabel(task.phase), task.elapsedMs > 0 ? ` · ${Math.round(task.elapsedMs / 1000)}s` : ''] })] }), _jsxs("span", { className: css.taskActions, children: [task.targetSessionId && _jsx("button", { type: "button", onClick: () => props.openSession(task.targetSessionId), children: "\u6253\u5F00" }), !['completed', 'failed', 'cancelled'].includes(task.phase) && _jsx("button", { type: "button", "data-danger": true, onClick: () => { void fetch(`${GATEWAY_ORIGIN}/api/tasks/${encodeURIComponent(task.id)}`, { method: 'DELETE' }); }, children: "\u4E2D\u65AD" })] })] }, task.id))) })), _jsxs("div", { className: css.hint, children: ["\u5F53\u524D\u9875\u9762\u4F1A\u8BDD\uFF1A", currentSessionId ? '已选择' : '未选择', "\u3002\u4E0D\u540C DSH \u4F1A\u8BDD\u53EF\u5E76\u884C\uFF1B\u540C\u4E00\u4F1A\u8BDD\u5185\u6309\u987A\u5E8F\u6267\u884C\u3002"] }), error && _jsx("div", { className: css.error, children: error })] }))] })), document.body);
}
